...
import { IdActiveSettings } from "@prisma/client";

export const columns: ColumnDef<IdActiveSettings>[] = [
  {
    id: "id",
    header: () => <div>No.</div>,
    cell: ({ row }) => (
...
interface AllHistoryTableProps {
  initialData: IdActiveSettings[] | null;
}

const AllHistoryTable: React.FC<AllHistoryTableProps> = ({ initialData }) => {
